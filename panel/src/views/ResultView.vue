...
<template>
  ...
  >
    ...
    <!-- Sekme Navigasyonu -->
    <div class="mb-6 max-w-4xl mx-auto px-4">
      <div class="bg-gray-100 dark:bg-slate-800 p-1 rounded-lg flex">
        <button
          @click="changeTab('photos')"
          class="flex-1 py-3 rounded-md transition-colors text-center font-medium"
          :class="{
    ...
    <div class="mx-4">
      ...
      <div
        ...
        class="bg-gray-100 dark:bg-slate-900 rounded-xl p-6 shadow-md"
      >
      ...
      <div
        ...
        class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-6"
      >
